...
class IO3NemoPicture extends StatefulWidget {
  const IO3NemoPicture({Key? key}) : super(key: key);

  @override
  _IO3NemoPictureState createState() => _IO3NemoPictureState();
}

class _IO3NemoPictureState extends State<IO3NemoPicture> {
          ...
          child: Column(
            ...
            children: [
              ...
              _lastStep
                  ...
                  : FloatingActionButton.extended(
                      onPressed: () {
                        final String? nemoState =
                            html.window.localStorage["nemo_state"];

                        if (nemoState != null) {
                          switch (nemoState) {
                            case "Exhibit1":
                              html.window.location.replace("../exhibit_2.html");
                              break;

                            case "Exhibit2":
                              html.window.location.replace("../exhibit_3.html");
                              break;

                            case "Exhibit3":
                              html.window.location.replace("../exhibit_4.html");
                              break;
                          }
                        } else {
                          setState(() {
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  "Toegang geweigerd of een onbekende fout heeft zich voorgedaan",
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: "cera-gr-medium",
                      fontSize: 24),
  ...
  void _takePicture() async {
    try {
      ...
      final String? nemoState = html.window.localStorage["nemo_state"];

      if (nemoState != null && nemoState == "Exhibit4") {
        _lastStep = true;
      }
